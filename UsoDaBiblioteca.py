...
# (Escolha se o grafo é direcionado ou não: True ou False) (Ex: True)
Objeto_Teste=Grafo('Lista', True)
#2. Importe um grafo de um arquivo texto (Ex: 'grafo_rf_1.txt')
Objeto_Teste.ImportarTxt('grafo_rf_1.txt')
#3. Utilize as novas funções disponíveis na classe Grafo
Objeto_Teste.Ford_Fulkerson(4,5) #Caso queira usar o algoritmo de Ford Fulkerson para determinar o fluxo máximo entre dois vértices no grafo (Ex: Vértices 4 e 5)
