...
#Estudos de Casos
#Exemplos para o Grafo 1 com representação em Lista e opção de grafo direcionado

Objeto_Teste=Grafo('Lista', True)
Objeto_Teste.ImportarTxt('grafo_rf_1.txt')

#Estudo de Caso 1 (Determinar o fluxo máximo entre o vértice 1 (fonte) e o vértice 2 (sumidouro))
Objeto_Teste.Ford_Fulkerson(1,2) 

#Estudo de Caso 2 (Executar 10 vezes o algoritmo de Ford Fulkerson entre os vértices 1 e 2
#e calcular a média do tempo de execução)
Objeto_Teste.Ford_Fulkerson(1,2)
